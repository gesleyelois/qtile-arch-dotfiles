...
keys = [
    ...
    Key([mod, "mod1"], "Left", lazy.layout.decrease_ratio(), desc="Decrease TreeTab panel width"),
    Key([mod, "mod1"], "Right", lazy.layout.increase_ratio(), desc="Increase TreeTab panel width"),
